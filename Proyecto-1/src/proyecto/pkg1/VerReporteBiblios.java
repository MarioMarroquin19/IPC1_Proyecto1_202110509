...
public class VerReporteBiblios extends JFrame implements ActionListener {
    JTextArea textCarga;
    ...
    VerReporteBiblios(){
        ...
        String []columnas = {"Tipo", "Autor", "Titulo", "Descripción","Edición"
        ,"Temas","Frecuencia Actual", "Ejemplares","Área", "Copias", "Disponibles"};
       GuardarBibliosMasiva[] datos = AlmBiblios.getbiblio();
        ReporteBibliografias generadorHtml = new ReporteBibliografias(datos,columnas);

       String reporteHtml = generadorHtml.obtenerReporteBiblios();
        ...
        this.setLayout(null);
        this.setTitle("REPORTE BIBLIOGRAFIAS");
