...
public class EliminarBiblio extends JFrame implements ActionListener{
    ...
    EliminarBiblio(){
        ...
        textEjemplares.setEditable(false);
        textArea = new JTextField();
        textArea.setEditable(false);
        textFrecuencia=new JTextField();
        textFrecuencia.setEditable(false);
        textTemas=new JTextField();
        textTemas.setEditable(false);
        ...
        this.setLayout(null);
        this.setTitle("Eliminar Bibliografia");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()==botonCrear){
            ...
            AlmBiblios.EliminarBiblios(Buscar);

            JOptionPane.showMessageDialog(null, "Eliminación completa!", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
