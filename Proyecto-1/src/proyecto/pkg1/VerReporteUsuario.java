...
public class VerReporteUsuario extends JFrame implements ActionListener {
    JTextArea textCarga;
    ...
    VerReporteUsuario(){
        ...
        String[] columnas = {"ID", "Nombre", "Apellido", "Usuario","Rol", "Password"};
        GuardarUsuarios[] datos = AlmUsuarios.getUsuarios();
        ReporteUsuarios generadorHtml = new ReporteUsuarios(datos,columnas);

       String reporteHtml = generadorHtml.obtenerReporteUsuarios();
